...
- Enable scripts: Account Settings > Gameplay > Allow Scripts > Allow Dangerous Scripts
...
0. COME BACK LATER because LoLa is still in beta; it cannot be installed yet...so ignore the steps below lol
