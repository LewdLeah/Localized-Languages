...
- Dear Creators, please paste `{Language: ${Select your language:}}` into your scenario Opening!
...
19. If using LoLa inside an existing adventure, submit `{Language: [Write Your Language Here]}` using Do/Say/Story
